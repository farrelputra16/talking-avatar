...
import { MeshPhysicalMaterial, LineBasicMaterial, Vector2, PlaneGeometry } from 'three';
...
function App() {
  ...
  const [text, setText] = useState(
    "My name is Valeri. I'm a virtual human who can speak whatever you type here along with realistic facial movements."
  );
